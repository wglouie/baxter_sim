...
if("TRUE" STREQUAL "TRUE")
  set(baxter_sim_hardware_SOURCE_PREFIX /home/louis/ros_ws/src/baxter_simulator/baxter_sim_hardware)
  set(baxter_sim_hardware_DEVEL_PREFIX /home/louis/ros_ws/devel)
  ...
  set(baxter_sim_hardware_INSTALL_PREFIX /home/louis/ros_ws/install)
...
if(NOT "/home/louis/ros_ws/src/baxter_simulator/baxter_sim_hardware/include;/usr/local/include/opencv;/usr/local/include " STREQUAL " ")
  set(baxter_sim_hardware_INCLUDE_DIRS "")
  set(_include_dirs "/home/louis/ros_ws/src/baxter_simulator/baxter_sim_hardware/include;/usr/local/include/opencv;/usr/local/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'baxter_sim_hardware' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/louis/ros_ws/src/baxter_simulator/baxter_sim_hardware/${idir}'.  Ask the maintainer 'Rethink Robotics Inc. <rsdk.support@rethinkrobotics.com>' to fix it.")
    endif()
    _list_append_unique(baxter_sim_hardware_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "baxter_sim_hardware;/usr/local/lib/libopencv_videostab.so.2.4.9;/usr/local/lib/libopencv_video.so.2.4.9;/usr/local/lib/libopencv_superres.so.2.4.9;/usr/local/lib/libopencv_stitching.so.2.4.9;/usr/local/lib/libopencv_photo.so.2.4.9;/usr/local/lib/libopencv_objdetect.so.2.4.9;/usr/local/lib/libopencv_nonfree.so.2.4.9;/usr/local/lib/libopencv_ml.so.2.4.9;/usr/local/lib/libopencv_legacy.so.2.4.9;/usr/local/lib/libopencv_imgproc.so.2.4.9;/usr/local/lib/libopencv_highgui.so.2.4.9;/usr/local/lib/libopencv_gpu.so.2.4.9;/usr/local/lib/libopencv_flann.so.2.4.9;/usr/local/lib/libopencv_features2d.so.2.4.9;/usr/local/lib/libopencv_core.so.2.4.9;/usr/local/lib/libopencv_contrib.so.2.4.9;/usr/local/lib/libopencv_calib3d.so.2.4.9")
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/louis/ros_ws/devel/lib;/opt/ros/indigo/lib)
